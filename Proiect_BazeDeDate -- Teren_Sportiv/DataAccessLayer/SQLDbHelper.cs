...
namespace NivelAccesDate
{
    ...
    public static class SqlDBHelper
    {
        ...
        public static int GetNextIdUtilizator()
        {
            int urmatorulId = 0;
            string query = "SELECT seq_Utilizatori.nextVal FROM dual";
        ...
        public static int GetNextIdTerenSportiv()
        {
            int urmatorulId = 0;
            string query = "SELECT seq_Terenuri_Sportive.nextVal FROM dual";
        ...
        public static int GetNextIdInchirieri()
        {
            int urmatorulId = 0;
            string query = "SELECT seq_Inchirieri.nextVal FROM dual";
